...
describe(path.basename(__dirname), () => {
	it('should work with test case 1', () => {
		expect(problemFunction([3, 9, 20, 15, 7], [9, 3, 15, 20, 7])).toEqual(createBinaryTreeFromArray([3, 9, 20, null, null, 15, 7]));
	});
	...
	it('should work with test case 5', () => {
		expect(problemFunction(
			[7, -10, -4, 3, -1, 2, -8, 11],
			[-4, -10, 3, -1, 7, 11, -8, 2])).toEqual(createBinaryTreeFromArray([7, -10, 2, -4, 3, -8, null, null, null, null, -1, 11],
		));
	});
});
